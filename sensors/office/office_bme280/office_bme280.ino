...
String mqttTopicRoom = "/home/data/office/";    // MQTT topic (first part)
...
void getAndSendValues() {
  ...
  /* TEMPERATURE */
  // Get value
  float temperature_degree = bme.readTemperature();
  ...
  Serial.print(String(humidity_percent,2));
  Serial.println(" %");

  // Write to MQTT broker
  mqttPubTopicStr = mqttTopicRoom + "humidity";
  retVal = publishFloatValueToMqttBroker(mqttPubTopicStr, humidity_percent);
